...
import { getAdminShortUrlString, formatDateTime, isExpired } from "@/lib/urlFormat"

interface AdminUrlsTableProps {
    urls: UrlResponse[]
}

export function AdminUrlsTable({ urls }: AdminUrlsTableProps) {
    ...
    return (
        <Table>
            ...
            <TableBody>
                {urls.map((url) => {
                    const fullShortUrl = getAdminShortUrlString(url.shortCode)
